...
- **Otherwise**, download `refresh-preview-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-refresh-any-view/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `refresh-preview-demo-vault-<version>` folder it unzips into.
